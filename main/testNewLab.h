...
class laby {
    ...
    public:
        ...
        void rotateMatrix(int position) {
            uint8_t leftPart=lab[position]>>4;//extrait la partie de gauche de l'octet
            uint8_t rightPart= lab[position] & 0xF;//extrait la partie de droite de l'octet
            if (position%2==0) {
            ...
            lab[position]= leftPart << 4 | rightPart;//recolle les deux parties
        }
        void shuffleLab() {
